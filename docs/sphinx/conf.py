...
project = 'seiya'
copyright = '{0}, {1}'.format('2018', 'José Sánchez-Galle')
...
htmlhelp_basename = '{0}pdoc'.format('seiya')
...
man_pages = [
    (master_doc, 'seiya', u'{0} Documentation'.format(project),
     [author], 1)
]
